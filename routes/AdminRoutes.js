...
class AdminRoutes {
    constructor() {
        ...
        this.adminValidator = new adminValidator_1.AdminValidator();
    ...
    initializeRoutes() {
        ...
        this.router
            ...
            .post(this.adminValidator.validateRegister(adminValidator_1.registerTicketRedeemerUserSchema), this.adminController.CreateTicketValidatorUser);
        /**
         * @swagger
        ...
        this.router
            .route('/ticket-redeemer-user/:id')
            .put(this.adminValidator.validateObjectUpdate(adminValidator_1.updateTicketRedeemerUserSchema), this.adminController.UpdateTicketRedeemerUser);
        /**
         * @swagger
         * /api/admin/roles/:
         *   get:
        ...
        this.router
            .route('/register-user')
            .post(this.adminValidator.validateRegister(adminValidator_1.registerUserSchema), this.adminController.CreateUser);
        /**
         * @swagger
        ...
        this.router
            ...
            .post(this.adminValidator.validateResetPassword(), this.adminController.ResetPassword);
        /**
         * @swagger
         * /api/admin/user/:
         *   get:
        ...
        this.router
            .route('/user/:id')
            .put(this.adminValidator.validateObjectUpdate(adminValidator_1.updaterUserSchema), this.adminController.UpdateUserById);
    }
}
